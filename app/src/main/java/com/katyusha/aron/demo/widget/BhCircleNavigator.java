 ...
 * alter by aron on 2017/03/29
 */
public class BhCircleNavigator extends View implements IPagerNavigator {
    private int mRadius;
    private int mCircleColor = Color.BLACK;
    private int mSelectedCircleColor = Color.WHITE;
    ...
    public BhCircleNavigator(Context context) {
        super(context);
        init(context);
    }
    ...
    public int getSelectedCircleColor(){
        return mSelectedCircleColor;
    }

    public void setNormalCircleColors(int selectedCircleColor){
