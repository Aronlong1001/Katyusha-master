...
data class ProductDetailBean(
		...
		@SerializedName("warrantyTags") var warrantyTags: List<Any>,
		...
		@SerializedName("productTags") var productTags: List<ProductTag>,
		@SerializedName("productAttributes") var productAttributes: Any, //null
		...
		@SerializedName("coupons") var coupons: List<Any>,
